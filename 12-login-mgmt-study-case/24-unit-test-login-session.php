<?php
/**
 * Unit Test for Session Login
 * 
 * 1. Remove exit() in View::redirect method (app/App/View.php)
 * <?php
 * 
 * ...
 ...
 * ...
 * 
 * 2. Create HomeControllerTest to test HomeController index method (tests/Controller/HomeControllerTest.php)
 * <?php
 * 
